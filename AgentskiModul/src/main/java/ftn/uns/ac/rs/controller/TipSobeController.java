...
public class TipSobeController {
	...
	public ResponseEntity<List<SifarnikDTO>> getAllSync(){
		return new ResponseEntity<List<SifarnikDTO>>(tipSobeService.getAllSync(), HttpStatus.OK);
	}
	
	@PostMapping(value = "createSync")
	public ResponseEntity<Integer> createSync(@RequestBody SifarnikDTO TipSobeDTO){
