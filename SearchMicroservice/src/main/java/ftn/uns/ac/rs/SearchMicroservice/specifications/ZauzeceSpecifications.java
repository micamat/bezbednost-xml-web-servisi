...
public class ZauzeceSpecifications {
	public static Specification<Zauzece> findByDate(Date begin, Date end){
		return new Specification<Zauzece>() {
			final Collection<Predicate> predicates = new ArrayList<Predicate>();
			private static final long serialVersionUID = 1L;
			@Override
			public Predicate toPredicate(Root<Zauzece> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
				if(begin != null) {
