...
public class CertificateController {
	...
	@GetMapping(value = "/certificatesR")
	public ResponseEntity<List<CertificateDetailDTO>> getCertificatesR(){
		if(certificateService.getAllCertificatesDetailsRevoked() == null) {
			return new ResponseEntity<List<CertificateDetailDTO>>(HttpStatus.NO_CONTENT);
		}
		return new ResponseEntity<List<CertificateDetailDTO>>(certificateService.getAllCertificatesDetailsRevoked(),HttpStatus.OK);
	}
